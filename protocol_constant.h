...
const unsigned int SIZE_MESSAGE_SIGNATURE_MESSAGE = SIZE_OPCODE + SIZE_CERTIFICATE_LEN + SIZE_RANDOM_DATA;
...
const unsigned int SIZE_MESSAGE_CHALLENGE_START = SIZE_OPCODE + SIZE_SEQNUMBER + SIZE_PUBLIC_KEY + SIZE_LEN+SIZE_IP_ADDRESS;
