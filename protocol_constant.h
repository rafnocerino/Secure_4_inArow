...
const unsigned int SIZE_MESSAGE_AVAILABLE_USER_LIST = SIZE_OPCODE + SIZE_SEQNUMBER + SIZE_LAST_FLAG + SIZE_LEN + pow(2,8*SIZE_LEN) + SIZE_IV + SIZE_TAG;
const unsigned int SIZE_MESSAGE_CHALLENGE_REQUEST = SIZE_OPCODE + SIZE_SEQNUMBER + SIZE_CHALLENGE_NUMBER + SIZE_LEN + pow(2,8*SIZE_LEN) + SIZE_IV + SIZE_TAG;
const unsigned int SIZE_MESSAGE_CHALLENGE_ACCEPTED = SIZE_OPCODE + SIZE_SEQNUMBER + SIZE_CHALLENGE_NUMBER + SIZE_IV + SIZE_TAG;
const unsigned int SIZE_MESSAGE_CHALLENGE_START = SIZE_OPCODE + SIZE_SEQNUMBER + SIZE_PUBLIC_KEY + SIZE_LEN + SIZE_IP_ADDRESS + SIZE_IV + SIZE_TAG ;
const unsigned int SIZE_MESSAGE_CHALLENGE_REFUSED = SIZE_OPCODE + SIZE_SEQNUMBER + SIZE_CHALLENGE_NUMBER + SIZE_IV + SIZE_TAG;
const unsigned int SIZE_MESSAGE_CHALLENGE_UNAVAILABLE = SIZE_OPCODE + SIZE_SEQNUMBER + SIZE_IV + SIZE_TAG ;
const unsigned int SIZE_MESSAGE_UPDATE_STATUS = SIZE_OPCODE + SIZE_SEQNUMBER + SIZE_STATUS_CODE + SIZE_LEN + pow(2,8*SIZE_LEN) + SIZE_IV + SIZE_TAG;
const unsigned int SIZE_MESSAGE_ACK = SIZE_OPCODE + SIZE_SEQNUMBER + SIZE_IV + SIZE_TAG;
const unsigned int SIZE_MESSAGE_EXIT = SIZE_OPCODE + SIZE_SEQNUMBER + SIZE_LEN + pow(2,8*SIZE_LEN) + SIZE_IV + SIZE_TAG;
const unsigned int SIZE_MESSAGE_MALFORMED_MEX = SIZE_OPCODE + SIZE_SEQNUMBER + SIZE_IV + SIZE_TAG;
const unsigned int SIZE_MESSAGE_DH_MESSAGE_INFO = SIZE_OPCODE + SIZE_DH_PUBLIC_KEY_LEN + SIZE_SIGNATURE + SIZE_RANDOM_DATA;
/*--------------------------------------------STATUS-CODE---------------------------------------------------------------*/
